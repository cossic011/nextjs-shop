...
function reducer(state, action) {
  switch (action.type) {
    ...
    case "PAY_FAIL":
      return { ...state, loadingPay: false, errorPay: action.paylaod };
    case "PAY_RESET":
                ...
                {paymentMethod === "PayPal" ? (
                  ...
                  <ListItem>
                    {isPending ? (
                      ...
                      >
                        Thank you, your order has been sent. It will be
                        delivered to your home address within 7 working days.
